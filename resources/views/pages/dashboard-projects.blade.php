        ...
        <div class="card h-md-100">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-dark">แผนงานวันนี้</span>
                    <span class="text-muted mt-1 fw-semibold fs-7">ทั้งหมด 20 แผนงาน</span>
                </h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
                    ...
                    <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_1">
                        ...
                        <div class="d-flex align-items-center mb-6">
                            ...
                            <div class="flex-grow-1 me-5">
                                ...
                                <div class="text-gray-400 fw-semibold fs-7">ผู้วางแผน
                                <!--begin::Name-->
                                <a href="#" class="text-primary opacity-75-hover fw-semibold">ผู้วางแผน Mark Morris</a>
                                <!--end::Name--></div>
                                <!--end::Link-->
                            </div>
                            <!--end::Info-->
