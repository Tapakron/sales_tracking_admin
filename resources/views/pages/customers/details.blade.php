        ...
        <div class="card-body pt-9 pb-0">
            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-6">
                ...
                <div class="d-flex flex-center flex-shrink-0 rounded w-100px h-100px w-lg-150px h-lg-150px me-7 mb-4">
                    @if ($pageDetails['customer_profile']['customer_img'] != null)
                        <img class="mw-50px mw-lg-100px" src="{{ asset($pageDetails['customer_profile']['customer_img']) }}" alt="image" />
                    @else
                        <img class="mw-50px mw-lg-100px" src="{{ asset('assets/media/avatars/300-10.jpg') }}" alt="image" />
                    @endif
                </div>
                <!--end::Image-->
                <!--begin::Wrapper-->
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-1">
                                <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bold me-3">{{ $pageDetails['customer_profile']['customer_name'] }}</a>
                                <!-- <span class="badge badge-light-success me-auto">In Progress</span> -->
                            </div>
                            <!--end::Status-->
                            <!--begin::Description-->
                            <div class="d-flex flex-wrap fw-semibold mb-2 fs-5 text-gray-400">{{ $pageDetails['customer_profile']['address_text'] }}</div>
                            <!--end::Description-->
                            <!--begin::Description-->
                            <div class="d-flex flex-wrap fw-semibold mb-2 fs-5 text-gray-400">{{ $pageDetails['customer_profile']['company_name'] }}</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Details-->
                        <!--begin::Actions-->
                        <div class="d-flex mb-4">
                            {{-- <a href="{{ url('/customers/edit/'.$pageDetails["customer_profile"]['customer_id']) }}" class="btn btn-sm btn-bg-light btn-active-color-primary me-3">แก้ไขข้อมูล</a> --}}
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="fs-4 fw-bold">{{ $pageDetails['customer_profile']['customer_tel_show'] }}</div>
                                </div>
                                <!--end::Number-->
                                <!--begin::Label-->
                            ...
                            @if ($pageDetails['customer_profile']['sale_name'] != null)
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    <div class="d-flex align-items-center">
                                        <div class="fs-4 fw-bold">{{ $pageDetails['customer_profile']['sale_name'] }}</div>
                                    </div>
        ...
        <div class="card-body pt-0">
            ...
            <div class="table-responsive">
                ...
                <table id="kt_profile_overview_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bold">
                    ...
                    <tbody class="fs-6">
                        @if (Count($pageDetails['contact_record']) > 0)
                            @foreach ($pageDetails['contact_record'] as $itemContact)
                                <tr>
                                    <td class="text-center">{{ $itemContact['row'] }}</td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="d-flex flex-column justify-content-center">
                                                <div class="fw-semibold text-gray-800">{{ $itemContact['detail'] }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center">{{ $itemContact['created_at'] }}</td>
                                    <td class="text-center">
                                        <span class="badge badge-primary ms-auto fw-bold px-2 py-1">{{ $itemContact['product_name'] }}</span>
                                    </td>

                                    <td class="text-center">{{ $itemContact['next_contact'] }}</td>
                                    <td class="text-center">
...
@section('modal-content')
    ...
    @section('js-content')
        <script src="{{ asset('assets/js-external/customers/details.js') }}"></script>
    @endsection
