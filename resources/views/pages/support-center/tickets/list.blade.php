            ...
            <div class="mb-10">
                ...
                <div class="d-flex mb-10">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Title-->
                            <a href="{{ url("/supportCenter/tickets/view") }}" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">ตารางโปรโมชันลูกค้าเดือนพฤษภาคม</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Content-->
                        <!--begin::Text-->
                ...
                <div class="d-flex mb-10">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Title-->
                            <a href="{{ url("/supportCenter/tickets/view") }}" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">ข่าวสารทั่วไป6</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Content-->
                        <!--begin::Text-->
                        <span class="text-gray-700 fw-semibold fs-6">Keenthemes to save tons and more to time money projects are Keenthemes to save tons and more to time money projects are...</span>
                        <!--end::Text-->
                        <!--begin::time-->
                        <span class="text-muted fw-semibold fs-7 mt-2">20/05/2024 13:00 น.</span>
                        <!--end::time-->
                ...
                <div class="d-flex mb-10">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Title-->
                            <a href="{{ url("/supportCenter/tickets/view") }}" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">ข่าวสารทั่วไป5</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Content-->
                        <!--begin::Text-->
                ...
                <div class="d-flex mb-10">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Title-->
                            <a href="{{ url("/supportCenter/tickets/view") }}" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">ข่าวสารทั่วไป4</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Content-->
                        <!--begin::Text-->
                ...
                <div class="d-flex mb-10">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Title-->
                            <a href="{{ url("/supportCenter/tickets/view") }}" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">ตารางโปรโมชันลูกค้าเดือนเมษายน</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Content-->
                        <!--begin::Text-->
                        <span class="text-gray-700 fw-semibold fs-6">Keenthemes to save tons and more to time money projects</span>
                        <!--end::Text-->
                        <!--begin::time-->
                        <span class="text-muted fw-semibold fs-7 mt-2">20/05/2024 13:00 น.</span>
                        <!--end::time-->
                ...
                <div class="d-flex mb-10">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Title-->
                            <a href="{{ url("/supportCenter/tickets/view") }}" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">ข่าวสารทั่วไป3</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Content-->
                        <!--begin::Text-->
                ...
                <div class="d-flex mb-10">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Title-->
                            <a href="{{ url("/supportCenter/tickets/view") }}" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">ข่าวสารทั่วไป2</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Content-->
                        <!--begin::Text-->
                ...
                <div class="d-flex mb-10">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Title-->
                            <a href="{{ url("/supportCenter/tickets/view") }}" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">ข่าวสารทั่วไป1</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Content-->
                        <!--begin::Text-->
