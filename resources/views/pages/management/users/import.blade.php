    ...
    <div class="card overflow-auto">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <!--begin::Toolbar-->
                <!-- <div class="me-5 align-items-center text-gray-500">เลือก 22 รายการ</div> -->
                ...
                <div class="d-flex justify-content-end align-items-center d-none" data-kt-user-table-toolbar="selected">
                    <div class="fw-bold me-5">เลือก
                        <span class="me-2" data-kt-user-table-select="selected_count"> </span>รายการ
                    </div>
                    <button type="button" class="btn btn-primary" data-kt-user-table-select="delete_selected">นำเข้าข้อมูล</button>
                </div>
                <!--end::Group actions-->
                ...
                <tbody class="text-gray-600 fw-semibold">
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ url("/management/users/view") }}" class="menu-link px-3">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">Robert Doe</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">John Miller</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{ url("/management/users/view") }}" class="text-gray-800 text-hover-primary mb-1">Lucy Kunic</a>
