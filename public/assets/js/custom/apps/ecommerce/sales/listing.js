...
var KTAppEcommerceSalesListing1 = (function () {
    var e,
      t,
      n,
      r,
      ...
      c = () => {
        e.querySelectorAll(
          '[data-kt-ecommerce-order-filter="move_row"]'
        ).forEach((e) => {
          e.addEventListener("click", function (e) {
            e.preventDefault();
            const n = e.target.closest("tr"),
            ...
            Swal.fire({
              text: "ต้องการเปลี่ยนสถานะเป็น Lost ของลูกค้า: " + r + "?",
              icon: "warning",
              showCancelButton: !0,
              buttonsStyling: !1,
              ...
              e.value
                ? Swal.fire({
                    text: "สถานะลูกค้า " + r + " เปลี่ยนเป็น Lost",
                    icon: "success",
                    buttonsStyling: !1,
                    confirmButtonText: "Ok, got it!",
                    customClass: { confirmButton: "btn fw-bold btn-primary" },
  ...
  KTUtil.onDOMContentLoaded(function () {
    KTAppEcommerceSalesListing1.init();
  });
